...
#'
#' @description Walks the user through the set up and use a general CTT analysis
#' of the assessment using a given sample.
#'
...
#'
#'
#' @return The Cronbach's Alpha, Item Difficulty, Item Discrimination,
#'  and Item Point-biserial statistics plus plots as specified in the walkthough.
#'
#' @export
#'
#' @examples
...
#'
cttGeneralAnalysis.Walkthrough <- function (data){
  # Set up Flags
  flag.perc = FALSE
  flag.booted = FALSE
  flag.nRuns = FALSE
