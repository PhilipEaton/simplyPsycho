...
#' Classical Test Theory item difficulty for the items on an assessment
...
#'
#'
#' @return The CTT Difficulty analysis as specified in the walkthough
#'
#' @export
#'
#' @examples
...
#'
cttDifficulty.Walkthrough <- function (data){
  # Set up Flags
  flag.booted = FALSE
  flag.nRuns = FALSE
  ...
  # ------------------------------------- #
  # Put it all together
  return(cttDifficulty(data, booted, nRuns, plotBarChart))
}
