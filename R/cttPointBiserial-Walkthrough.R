...
#'
#'
#' @return The CTT Point-biserial analysis as specified in the walkthough
#'
#' @export
#'
#' @examples
...
#'
cttPointBiserial.Walkthrough <- function (data){
  # Set up Flags
  flag.booted = FALSE
  flag.nRuns = FALSE
  ...
  # ------------------------------------- #
  # Put it all together
  return(cttpointBiserial(data, booted, nRuns, plotBarChart))
}
